<template>
  <div
    id="modal"
    class="modal w-full h-screen fixed top-0 left-0 z-10 flex items-center justify-center"
  >
    <div class="modal__body card flex flex-col">
      <div class="card__title">
        <div class="report__menu flex overflow-hidden w-full">
          <!-- Cash Flow -->
          <button
            :class="[activeComponent === 'cash-flow' ? 'active' : '']"
            class="report__btn rounded-full p-4"
          >
            <svg
              id="Cash-01"
              xmlns="http://www.w3.org/2000/svg"
              class="fill-current text-lg text-orange-default"
              width="30"
              height="30"
              viewBox="0 0 30 33"
            >
          ...
          <!-- Investments -->
          <button
            :class="[activeComponent === 'investments' ? 'active' : '']"
            class="report__btn rounded-full p-4"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <!-- Real Estate -->
          <button
            :class="[activeComponent === 'real-state' ? 'active' : '']"
            class="report__btn rounded-full p-4"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span class="background__circle bg-red-default"></span>
          </button>

          <!-- Insurance -->
          <button
            :class="[activeComponent === 'insurance' ? 'active' : '']"
            class="report__btn rounded-full p-4"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <!-- Legal Planning -->
          <button
            :class="[activeComponent === 'legal-planning' ? 'active' : '']"
            class="report__btn rounded-full p-4"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <!-- Tax Planning -->
          <button
            :class="[activeComponent === 'tax-planning' ? 'active' : '']"
            class="report__btn rounded-full p-4"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="card__body flex-grow"></div>
