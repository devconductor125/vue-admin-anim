    ...
    >
      ...
      <div class="sidemenu pt-5">
        ...
        <router-link
            ...
            id="link0"
        >
         <div class="link-content" @click="showTab(0)">
           <svg
               id="Bashboard-01"
           ...
           <p class="sidemenu__label text-gray-100" >
             Dashboard
           </p>
         </div>
        </router-link>
        ...
        <router-link
            ...
            id="link1"
        >
         <div class="link-content" @click="showTab(1)">
           <svg
               id="Cash-01"
               xmlns="http://www.w3.org/2000/svg"
        ...
        <router-link
            ...
            id="link2"
        >
          <div class="link-content" @click="showTab(2)">
            <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <router-link
            ...
            id="link3"
        >
          <div class="link-content" @click="showTab(3)">
            <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <router-link
            ...
            id="link4"
        >
          <div class="link-content" @click="showTab(4)">
            <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <router-link
            ...
            id="link5"
        >
          <div class="link-content" @click="showTab(5)">
            <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <router-link
            ...
            id="link6"
        >
          <div class="link-content" @click="showTab(6)">
            <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <router-link
            ...
            id="link7"
        >
          <div class="link-content" @click="showTab(7)">
            <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <router-link
            to="/learn"
            class="sidemenu__link mt-6"
            data-index="8"
            id="link8"
        >
          <div class="link-content" @click="showTab(8)">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
        ...
        <router-link
            ...
            id="link9"
        >
         <div class="link-content"  @click="showTab(9)">
           <svg
               xmlns="http://www.w3.org/2000/svg"
               width="20"
               height="20"
        ...
        <router-link
            ...
            id="link10"
        >
         <div class="link-content"  @click="showTab(10)">
           <svg
               xmlns="http://www.w3.org/2000/svg"
               width="20"
               height="20"
        ...
        <router-link
            ...
            id="link11"
        >
         <div class="link-content"  @click="showTab(11)">
           <svg
               xmlns="http://www.w3.org/2000/svg"
               width="20"
               height="20"
        ...
        <div class="mover" id="mover" v-on:onload="onLoadHandler">
          <div class="top-radius" id="top"></div>
          <div class="bottom-radius" id="bottom"></div>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    showTab(index) {
      const item = document.getElementById('link' + index)
      const mover = document.getElementById('mover');
      const top = document.getElementById('top');
      const bottom = document.getElementById('bottom');
      mover.style.top = item.getBoundingClientRect().y + 'px';
      mover.style.backgroundColor = backgrounds[index];
      top.style.backgroundColor = backgrounds[index];
      bottom.style.backgroundColor = backgrounds[index];
    },
    onLoadHandler: function(){
      const item = document.getElementsByClassName('router-link-active')[0]
