<template>
  <div>
    <div class="flex justify-between">
      <div class="mb-2 py-1 flex items-center">
        <h2 class="text-xl font-bold">Joint Account</h2>
      </div>
    </div>
    <div class="flex gap-4 w-full text-orange-900 mb-2">
      <div class="w-full">
        <div class="card bg-white flex flex-col">
          <div class="card__title font-bold">
            <h3>Liquidity Needs Calculation</h3>
          </div>
          <div class="card__body text-center w-full">
            <div class="table__wrapper flex flex-col overflow-auto">
              <table class="w-full">
                <tbody>
                  <tr>
                    <td class="text-left">Target Liquidity Level</td>
                    <th class="text-right">$119,816</th>
                  </tr>
                  <tr>
                    <td class="text-left">
                      Average Low Watermark (Three Months)
                    </td>
                    <th class="text-right">$115,574</th>
                  </tr>
                  <tr>
                    <td class="text-left">Current Balance</td>
                    <th class="text-right">$50,816</th>
                  </tr>
                  <tr>
                    <td class="text-left">Excess Liquidity</td>
                    <th class="text-right">$65,574</th>
                  </tr>
                </tbody>
              </table>
            </div>
          </div>
          <div class="card__footer flex-grow mt-8">
      ...
      <div class="w-full">
        <div class="card bg-white">
          <div class="card__body relative w-full">
            <div class="mb-2">
              <div class="mb-1 font-bold">Spill Over</div>
              <div class="flex justify-between my-1">
                <div>Automatically Sweep Excess Liquidity</div>
                <switch-button
                  v-model="spillOption"
                  color="#805124"
                  background="#FED788"
              ...
              <div class="flex justify-between my-1">
                <div>Automatically Adjusted</div>
                <switch-button
                  v-model="adjustOption"
                  color="#805124"
                  background="#FED788"
                >
                </switch-button>
              ...
              <div class="flex justify-between my-1">
                ...
                <div class="dropdown relative w-64">
                  <button
                    ...
                    @click.self="expand($event)"
                  >
                    <span class="pointer-events-none">Weekly</span>
                    <i
                      class="fas fa-caret-down dropdown-icon pointer-events-none self-center"
                    ></i>
                  </button>
              ...
              <div class="flex justify-between my-1">
                ...
                <div class="dropdown relative w-64">
                  <button
                    ...
                    @click.self="expand($event)"
                  >
                    <span class="pointer-events-none">September 20, 2020</span>
                    <i
                      class="fas fa-caret-down dropdown-icon pointer-events-none self-center"
                    ></i>
                  </button>
              ...
              <div class="flex justify-between my-1">
                <div>Projected First Sweep Amount</div>
                <div class="font-bold">$119,223</div>
              </div>
              <div class="flex justify-between my-1">
                <div>Projected Weekly Sweep Amount</div>
                <div class="font-bold">$223</div>
              </div>
            </div>
            <div class="my-1">
              <div class="mb-1 font-bold">Activity</div>
              <div class="flex justify-between">
                <div>Work towards your goals as you spend money</div>
                <switch-button
        ...
        <div class="flex justify-end mt-4">
          <button
            class="w-32 rounded-full font-bold bg-orange-900 h-full text-white px-4 py-1"
          >
            Save
          </button>
        </div>
...
import ActivityFlow from "@/components/cashflow/wells-fargo/move-money/sweep/ActivityFlow";
