<template>
  <div>
    <div class="flex justify-between">
      ...
      <div class="text-lg flex justify-end items-center gap-4 mb-2">
    ...
    <div class="flex relative gap-4 w-full text-orange-900 mb-2">
      <div class="w-full">
            ...
            <div class="table__wrapper flex flex-col h-full overflow-auto">
              <table class="w-full">
                <tbody>
                  ...
                  <tr>
                    <td class="text-left">Transfer Amount</td>
                  ...
                  <tr>
                    <td class="text-left">Transfer Date</td>
                    <th class="text-right">September 20, 2020</th>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <div class="flex items-center justify-center">
        <svg
          ...
          height="50"
          viewBox="0 0 50 50"
          class="fill-current text-orange-900"
        >
          <path
            id="ic_forward_24px"
            d="M29,16.5V4L54,29,29,54V41.5H4v-25Z"
              ...
              <table class="w-full">
                <tbody>
                  <tr>
                    ...
                    <th class="text-right flex justify-end">
                  ...
                  <tr>
                    <td class="text-left">Name</td>
                    <th class="text-right">John's E-Trade Account</th>
                  </tr>
                  <tr>
                    <td class="text-left">Ownership</td>
                    <th class="text-right">John Doe</th>
                  </tr>
                  <tr>
                    <td class="text-left">Location</td>
                    <th class="text-right">
                      E-Trade Taxable Inveestment Account
                    </th>
                  </tr>
