<template>
  ...
  >
    <div
      :class="activeComponent === 'wells-fargo-transfer' ? 'active' : ''"
      class="tab cursor-pointer rounded-full text-center h-full px-4 py-2"
      @click="showTabMenu('wells-fargo-transfer')"
      data-index="0"
    >
    ...
    <div
      :class="activeComponent === 'wells-fargo-sweep' ? 'active' : ''"
      class="tab cursor-pointer rounded-full text-center h-full px-4 py-2"
      @click="showTabMenu('wells-fargo-sweep')"
      data-index="1"
    >
    ...
    <div
      :class="activeComponent === 'wells-fargo-bill-pay' ? 'active' : ''"
      class="tab cursor-pointer rounded-full text-center h-full px-4 py-2"
      @click="showTabMenu('wells-fargo-bill-pay')"
      data-index="2"
    >
    ...
    <div
      :class="activeComponent === 'wells-fargo-send' ? 'active' : ''"
      class="tab cursor-pointer rounded-full text-center h-full px-4 py-2"
      @click="showTabMenu('wells-fargo-send')"
      data-index="3"
    >
