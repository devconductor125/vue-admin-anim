<template>
  <div class="flex flex-wrap justify-center gap-4 font-bold">
    ...
    <wells-fargo-information-menu @change="$emit('change', $event)"></wells-fargo-information-menu>
...
export default {
  ...
  data() {
    return {
      menu: {'information' : 'wells-fargo-information-menu', 'move-money' : 'wells-fargo-move-money-menu'},
