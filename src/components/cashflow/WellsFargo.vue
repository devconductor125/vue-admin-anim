<template>
  <div
    ...
    :class="collapse ? 'lg:pl-72' : ''"
  >
    <div
      class="card__title flex justify-between items-center"
      :class="collapse ? 'lg:ml-8' : 'lg:ml-72'"
    >
      <wells-fargo-tab-menu
    ...
    <div class="card__body p-1 flex-grow overflow-y-auto">
...
export default {
  data() {
    return {
      activeTabName: "information",
      activeComponent: "wells-fargo-details",
    };
  },
  methods: {
      changeContent($event) {
        this.activeTabName = $event.component;
        this.activeComponent = $event.tab;
      },
  }
};
</script>