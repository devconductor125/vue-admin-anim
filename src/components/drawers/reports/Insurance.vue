<template>
  <div class="report__content__wrapper text-base text-blue-default">
    <div
      class="report__content__tabs rounded-full border-blue-default border-2 bg-transparent grid grid-flow-col grid-cols-3 w-full justify-between font-bold"
    >
      <div
...
<script>
import Statements from "@/components/drawers/reports/insurance/Statements";
import Other from "@/components/drawers/reports/insurance/Other";
import Reports from "@/components/drawers/reports/insurance/Reports";
export default {
  components: {
    Statements,
    Other,
...
.report__content__tabs {
  .tab {
    ...
    .background__circle {
      ...
      z-index: 1;
      @apply absolute h-full w-full rounded-full inline-block bg-blue-default text-gray-dark;
    }
