<template>
  <div class="report__content__wrapper text-base text-orange-default">
    <div
      class="report__content__tabs rounded-full border-orange-default border-2 bg-transparent grid grid-flow-col grid-cols-3 w-full justify-between font-bold"
    >
      <div
...
<script>
import Statements from "@/components/drawers/reports/cash-flow/Statements";
import Reports from "@/components/drawers/reports/cash-flow/Reports";
import Other from "@/components/drawers/reports/cash-flow/Other";
export default {
  components: {
    Statements,
    Reports,
...
.report__content__tabs {
  .tab {
    ...
    .background__circle {
      ...
      z-index: 1;
      @apply absolute h-full w-full rounded-full inline-block bg-orange-default text-gray-dark;
    }
