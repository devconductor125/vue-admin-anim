  ...
  <div class="tab__content__wrapper">
    <div id="accordion">
      <div class="dropdown my-2">
        ...
        >
          <span class="pointer-events-none">Life Insurance</span>
      ...
      <div class="dropdown my-2">
        <button
          ...
          @click.self="expand($event)"
        >
          <span class="pointer-events-none">Long Time Care Insurance</span>
          <i class="fas fa-caret-down dropdown-icon pointer-events-none self-center"></i>
        </button>
        <div class="dropdown__menu">
          <ul>
      ...
      <div class="dropdown my-2">
        <button
          ...
          @click.self="expand($event)"
        >
          <span class="pointer-events-none">Disability Insurance</span>
          <i class="fas fa-caret-down dropdown-icon pointer-events-none self-center"></i>
        </button>
        <div class="dropdown__menu">
          <ul>
      ...
      <div class="dropdown my-2">
        <button
          ...
          @click.self="expand($event)"
        >
          <span class="pointer-events-none">Health Insurance</span>
          <i class="fas fa-caret-down dropdown-icon pointer-events-none self-center"></i>
        </button>
        <div class="dropdown__menu">
          <ul>
