<template>
  <div class="report__content__wrapper text-base text-purple-default">
    <div
      class="report__content__tabs rounded-full border-purple-default border-2 bg-transparent grid grid-flow-col grid-cols-3 w-full justify-between font-bold"
    >
      <div
...
<script>
import Statements from "@/components/drawers/reports/tax-planning/Statements";
import Other from "@/components/drawers/reports/tax-planning/Other";
import Reports from "@/components/drawers/reports/tax-planning/Reports";
export default {
  components: {
    Statements,
    Other,
...
.report__content__tabs {
  .tab {
    ...
    .background__circle {
      ...
      z-index: 1;
      @apply absolute h-full w-full rounded-full inline-block bg-purple-default text-gray-dark;
    }
