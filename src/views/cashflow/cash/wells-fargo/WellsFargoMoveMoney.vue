      ...
      <div class="mx-auto">
        <div class="flex justify-center gap-4 font-bold">
          <!-- <div
            ...
            class="cashflow__content__tabs rounded-full font-bold bg-white grid grid-flow-col grid-cols-2 justify-between"
          > -->
          <div
            class="flex flex-wrap bg-white items-center rounded-lg sm:rounded-full h-10 shadow mt-5 lg:mt-0 sm:w-max"
          >
            <router-link
              ...
              "
            >
              <!-- :class="$route.matched.contains('information') ? 'yes' : 'nope'" -->
              <!-- :class="$route.matched[0].path" -->
          ...
          <wells-fargo-move-money-menu></wells-fargo-move-money-menu>
          <div class="cashflow__access__button rounded-full bg-white">
            <button
...
import WellsFargoMoveMoneyMenu from "@/components/layouts/WellsFargoMoveMoneyMenu";
...
export default {
  ...
  data() {
    return {
      activeComponent: "wells-fargo-transfer",
      activeOldIndex: 0,
  ...
  methods: {
    ...
    showContentTab(name) {
      ...
      if (name != this.activeComponent) {
        ...
        setTimeout(() => {
          this.activeCurrentIndex = 0;
          this.activeComponent = "wells-fargo-transfer";
        }, 500);
      }
    },
  },
