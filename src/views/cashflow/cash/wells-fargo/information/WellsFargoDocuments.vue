<template>
  <div class="h-full">
    ...
    <div
      class="grid grid-cols-1 lg:grid-cols-3 gap-4 w-full text-orange-900 mb-2"
    >
      <div class="card bg-white">
        <div class="cart__title flex justify-between font-bold items-center">
          <h3>Statements</h3>
          <button
      ...
      <div class="card bg-white">
        <div class="cart__title flex justify-between font-bold items-center">
          <h3>Others</h3>
          <button
            class="rounded-full disabled:opacity-50 font-bold bg-orange-900 h-full text-white px-4 py-1"
            disabled
          >
            Show more
          </button>
        ...
        <div class="card__body relative w-full">
          <p>Addres change confirmation</p>
        </div>
      </div>
    </div>
    <div class="flex justify-end fixed bottom-8 right-8">
      <i class="p-2 rounded-full text-white bg-orange-900 ml-auto">
      <svg
      ...
      >
        <path
          ...
          fill-rule="evenodd"
          class="shp0"
          d="M80 37.67C80 46.87 72.53 54.33 63.33 54.33L20 54.33C8.97 54.33 0 45.37 0 34.33C0 24.03 7.8 15.53 17.83 14.47C22 6.47 30.37 1 40 1C52.13 1 62.23 9.63 64.5 21.13C73.17 21.73 80 28.87 80 37.67ZM56.67 31L40 14.33L23.33 31L33.33 31L33.33 44.33L46.67 44.33L46.67 31L56.67 31Z"
        />
      </svg>
      </i>
    </div>
